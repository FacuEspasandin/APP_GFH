 ...
 *
 * Fondo sólido + texto blanco, SIN ícono — con 6 niveles, un ícono compartido
 * entre varios (como pasaba con "alerta" en los tres primeros) no aportaba
 * nada que el color y la palabra no dijeran ya.
 */
